  ...
  return (
    <PageTemplate>
      <section className="space-y-6 text-center" data-aos="zoom-in-up">
        <PageSentence badge="" title={`Privacy Policy`} />
      ...
      <section className="grid place-items-center" data-aos="fade-up">
        <div className="w-full sm:w-10/12 md:w-8/12 space-y-10">
          <div className="space-y-2.5 text-white">
            <p>
              {" "}
              Gulerworks (“we,” “our,” or “us”) is committed to protecting your
              privacy. This Privacy Policy explains how your personal
              information is collected, used, and disclosed by Gulerworks.
            </p>
            <p>
              This Privacy Policy applies to our website, and its associated
              subdomains (collectively, our “Service”) alongside our
              application, Gulerworks. By accessing or using our Service, you
            ...
            <p>
              ...
              <ul>
                ...
                <li>
                  ...
                  “our,” it refers to Gulerworks LTD, 71-75 Shelton Street,
                  Covent Garden, WC2H 9JQ, London, United Kingdom that is
                ...
                <li>
                  ...
                  signs up to use the Gulerworks Service to manage the
                ...
                <li>
                  ...
                  Gulerworks or are under contract to perform a service on
                ...
                <li>
                  Website: Gulerworks&apos;s site, which can be accessed via
                  this URL: gulerworks.com
                </li>
                <li>
            ...
            <h1 className="text-2xl">Information automatically collected</h1>
            <p>
            ...
            <h1 className="text-2xl">Personnel</h1>
            <p>
              If you are a Gulerworks worker or applicant, we collect
            ...
            <h1 className="text-2xl">Affiliates</h1>
            <p>
              ...
              under common control with Gulerworks, whether by ownership or
            ...
            <p>
              ...
              shall govern this Agreement and your use of the website. Your use
              of the website may also be subject to other local, state,
              national, or international laws.
            </p>
            <p>
              By using Gulerworks or contacting us directly, you signify your
            ...
            <h1 className="text-2xl">Kids&apos; Privacy</h1>
            <p>
            ...
            <h1 className="text-2xl">Changes To Our Privacy Policy</h1>
            <p>
            ...
            <h1 className="text-2xl">What is GDPR?</h1>
            <p>
            ...
            <h1 className="text-2xl">What is personal data?</h1>
            <p>
            ...
            <h1 className="text-2xl">Why is GDPR important?</h1>
            <p>
              ...
              facts it&apos;s simply the right thing to do. At Gulerworks we
            ...
            <p>
              ...
              rights requirements of GDPR. Gulerworks processes or stores all
            ...
            <p>
              ...
              retrieve and remove personal data. We got you! We&apos;ve been set
              up as self service from the start and have always given you access
