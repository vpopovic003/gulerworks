  ...
  return (
    <PageTemplate>
      <section className="space-y-6 text-center" data-aos="zoom-in-up">
        ...
        <Text textStyle="BlogMeta" value="Updated at 2024-08-07" />
      </section>
      <LineDivider />
      <section className="grid place-items-center" data-aos="fade-up">
        <div className="w-full sm:w-10/12 md:w-8/12 space-y-10">
          <div className="space-y-2.5 text-white">
            <h1 className="text-2xl">General Terms</h1>
            <p>
              By accessing and placing an order with Gulerworks, you confirm
              ...
              communication between you and Gulerworks.
            </p>
            <p>
              Under no circumstances shall Gulerworks team be liable for any
              ...
              even if Gulerworks team or an authorized representative has been
            ...
            <p>
              Gulerworks will not be responsible for any outcome that may occur
            ...
            <p>
              Gulerworks grants you a revocable, non-exclusive,
            ...
            <ul>
              ...
              <li>
                ...
                “our,” it refers to GULERWORKS LTD, 71-75 Shelton Street, Covent
                Garden, WC2H 9JQ, London, United Kingdom that is responsible for
              ...
              <li>
                ...
                Gulerworks and use the services.
              </li>
              <li>
                Service: refers to the service provided by Gulerworks as
            ...
            <h1 className="text-2xl">Restrictions</h1>
            ...
            <ul>
              ...
              <li>
                ...
                notice of copyright or trademark) of Gulerworks or its
                affiliates, partners, suppliers or the licensors of the website.
              </li>
            </ul>
            <h1 className="text-2xl">Return and Refund Policy</h1>
            <p>
              Thanks for shopping at Gulerworks. We appreciate the fact that you
            ...
            <p>
              ...
              Gulerworks. We are not responsible for the content, accuracy or
            ...
            <p>
              You acknowledge and agree that Gulerworks may stop (permanently or
              ...
              You do not need to specifically inform Gulerworks when you stop
              using the Service. You acknowledge and agree that if Gulerworks
            ...
            <h1 className="text-2xl">Modifications to Our website</h1>
            <p>
              Gulerworks reserves the right to modify, suspend or discontinue,
            ...
            <h1 className="text-2xl">Updates to Our website</h1>
            <p>
            ...
            <p>
              ...
              functionalities of the website. You agree that Gulerworks has no
            ...
            <h1 className="text-2xl">Third-Party Services</h1>
            <p>
            ...
            <p>
              ...
              legality, decency, quality or any other aspect thereof. Gulerworks
            ...
            <p>
              Gulerworks may, in its sole discretion, at any time and for any or
            ...
            <p>
              ...
              from Gulerworks, in the event that you fail to comply with any
            ...
            <p>
              ...
              liability of Gulerworks and any of its suppliers under any
            ...
            <p>
              ...
              shall Gulerworks or its suppliers be liable for any special,
              ...
              even if Gulerworks or any supplier has been advised of the
            ...
            <p>
              ...
              legal notices published by Gulerworks on the Services, shall
              constitute the entire agreement between you and Gulerworks
            ...
            <h1 className="text-2xl">Amendments to this Agreement</h1>
            <p>
            ...
            <p>
              ...
              Gulerworks regarding your use of the website and supersedes all
            ...
            <h1 className="text-2xl">Updates to Our Terms</h1>
            <p>
            ...
            <h1 className="text-2xl">Intellectual Property</h1>
            <p>
              The website and its entire contents, features and functionality
              (including but not limited to all information, software, text,
              displays, images, video and audio, and the design, selection and
              arrangement thereof), are owned by Gulerworks, its licensors or
              ...
              permission of Gulerworks, unless and except as is expressly
              provided in these Terms & Conditions. Any unauthorized use of the
              material is prohibited.
            </p>

            <h1 className="text-2xl">Agreement to Arbitrate</h1>
            <p>
            ...
            <h1 className="text-2xl">Notice of Dispute</h1>
            <p>
              In the event of a dispute, you or Gulerworks must give the other a
            ...
            <p>
              If you and Gulerworks don’t resolve any dispute by informal
            ...
            <h1 className="text-2xl">Submissions and Privacy</h1>
            <p>
              ...
              property of Gulerworks without any compensation or credit to you
              whatsoever. Gulerworks and its affiliates shall have no
            ...
            <p>
              Gulerworks may, from time to time, include contests, promotions,
            ...
            <h1 className="text-2xl">Typographical Errors</h1>
            <p>
            ...
            <p>
              ...
              signed by an authorized representative of Gulerworks. Gulerworks
              ...
              breach or anticipatory breach by you. Gulerworks operates and
              controls the Gulerworks Service from its offices in . The Service
              ...
              who choose to access the Gulerworks Service from other locations
              ...
              incorporate the Gulerworks Privacy Policy) contains the entire
              understanding, and supersedes all prior understandings, between
              you and Gulerworks concerning its subject matter, and cannot be
            ...
            <p>
              Gulerworks is not responsible for any content, code or any other
              imprecision.
            </p>
            <p>Gulerworks does not provide warranties or guarantees.</p>
            <p>
              In no event shall Gulerworks be liable for any special, direct,
            ...
            <ul>
              ...
              <li>Via this Link: https://gulerworks.com/contact</li>
            </ul>
          </div>
        </div>
      </section>
